...
interface ExporterFactory {
    ...
    Exporter createExporter(String type, Object domain, List fields, Map labels, Map formatters, Map parameters, Object[] otherParameters) throws ExporterNotFoundException
