	...
	<body>		
		<div id="tb" class="scaffoldbar">			
			...
			%{--<div class="scaffoldbar-right">
				...
				<div id="mm" >
					<div data-options="name:'name'"><g:message code="company.name"/></div>       					 
				</div>
			</div>--}%
		</div>
		...
		<e:datagrid id="grid" idField="id" fit="true" fitColumns="true" pagination="true" toolbar="#tb" 
			...
			<e:columns>
				...
				<e:column field="id" hidden="true" width="50"><g:message code="company.id"/></e:column>  						
				<e:column field="name" sortable="true" width="50"><g:message code="company.name"/></e:column>																				  												
			</e:columns>			
		</e:datagrid>
